...
![BGP Lab Topology][([images/topology-full.png])](https://github.com/Kuba-svg/bgp-masterclass-labs/blob/main/bgp-masterclass-labs/images/topology-full.png?raw=true)
